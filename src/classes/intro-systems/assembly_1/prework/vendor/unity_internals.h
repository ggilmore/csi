...
#ifdef UNITY_INCLUDE_PRINT_FORMATTED
void
UnityPrintFormatted(const char* format, ...);
#endif
...
#define RUN_TEST(...)                                                          \
  UnityDefaultTestRun(RUN_TEST_FIRST(__VA_ARGS__), RUN_TEST_SECOND(__VA_ARGS__))
#define RUN_TEST_FIRST(...) RUN_TEST_FIRST_HELPER(__VA_ARGS__, throwaway)
#define RUN_TEST_FIRST_HELPER(first, ...) (first), #first
#define RUN_TEST_SECOND(...)                                                   \
  RUN_TEST_SECOND_HELPER(__VA_ARGS__, __LINE__, throwaway)
...
#define UNITY_TEST_ASSERT_EACH_EQUAL_INT(                                      \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(UnityNumToPtr((UNITY_INT)(expected), sizeof(int)),  \
                           (UNITY_INTERNAL_PTR)(actual),                       \
                           (UNITY_UINT32)(num_elements),                       \
                           (message),                                          \
                           (UNITY_LINE_TYPE)(line),                            \
...
#define UNITY_TEST_ASSERT_EACH_EQUAL_UINT(                                     \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
    UnityNumToPtr((UNITY_INT)(expected), sizeof(unsigned int)),                \
    (UNITY_INTERNAL_PTR)(actual),                                              \
    (UNITY_UINT32)(num_elements),                                              \
    (message),                                                                 \
    (UNITY_LINE_TYPE)(line),                                                   \
...
#define UNITY_TEST_ASSERT_EACH_EQUAL_PTR(                                      \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
    UnityNumToPtr((UNITY_PTR_TO_INT)(expected), sizeof(int*)),                 \
    (UNITY_INTERNAL_PTR)(actual),                                              \
    (UNITY_UINT32)(num_elements),                                              \
    (message),                                                                 \
    (UNITY_LINE_TYPE)(line),                                                   \
