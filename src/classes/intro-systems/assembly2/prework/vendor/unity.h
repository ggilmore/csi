...
#include "unity_internals.h"
   ...
   *-------------------------------------------------------
   * All options described below should be passed as a compiler flag to all
   files using Unity. If you must add #defines, place them BEFORE the #include
   above.
   ...
   *     - define UNITY_FLOAT_PRECISION to specify the precision to use when
   doing TEST_ASSERT_EQUAL_FLOAT
   *     - define UNITY_FLOAT_TYPE to specify doubles instead of single
   precision floats
   *     - define UNITY_INCLUDE_DOUBLE to allow double floating point
   comparisons
   ...
   *     - by default, test and failure counters are unsigned shorts.  Define
   UNITY_COUNTER_TYPE with a different type if you want to save space or have
   more than 65535 Tests.

   * Test Cases
   *     - define UNITY_SUPPORT_TEST_CASES to include the TEST_CASE macro,
   though really it's mostly about the runner generator script
   ...
   *     - you'll want to define UNITY_USE_COMMAND_LINE_ARGS if you have the
   test runner passing arguments to Unity
...
#define TEST_ASSERT_BIT_HIGH(bit, actual)                                      \
  UNITY_TEST_ASSERT_BITS(                                                      \
    ((UNITY_UINT)1 << (bit)), (UNITY_UINT)(-1), (actual), __LINE__, NULL)
#define TEST_ASSERT_BIT_LOW(bit, actual)                                       \
  UNITY_TEST_ASSERT_BITS(                                                      \
    ((UNITY_UINT)1 << (bit)), (UNITY_UINT)(0), (actual), __LINE__, NULL)
...
#define TEST_ASSERT_GREATER_OR_EQUAL_INT16(threshold, actual)                  \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_INT16(                                    \
    (threshold), (actual), __LINE__, NULL)
...
#define TEST_ASSERT_INT_ARRAY_WITHIN(delta, expected, actual, num_elements)    \
  UNITY_TEST_ASSERT_INT_ARRAY_WITHIN(                                          \
    (delta), (expected), (actual), num_elements, __LINE__, NULL)
...
#define TEST_ASSERT_EQUAL_STRING_LEN(expected, actual, len)                    \
  UNITY_TEST_ASSERT_EQUAL_STRING_LEN(                                          \
    (expected), (actual), (len), __LINE__, NULL)
...
#define TEST_ASSERT_EQUAL_INT_ARRAY(expected, actual, num_elements)            \
  UNITY_TEST_ASSERT_EQUAL_INT_ARRAY(                                           \
    (expected), (actual), (num_elements), __LINE__, NULL)
...
#define TEST_ASSERT_EQUAL_MEMORY_ARRAY(expected, actual, len, num_elements)    \
  UNITY_TEST_ASSERT_EQUAL_MEMORY_ARRAY(                                        \
    (expected), (actual), (len), (num_elements), __LINE__, NULL)
...
#define TEST_ASSERT_EQUAL(expected, actual)                                    \
  UNITY_TEST_ASSERT_EQUAL_MEMORY(                                              \
    (&expected), (&actual), sizeof(expected), __LINE__, NULL)
#define TEST_ASSERT_NOT_EQUAL(expected, actual)                                \
  UNITY_TEST_FAIL(__LINE__, UnityStrErrShorthand)
#endif
...
#define TEST_ASSERT_BITS_HIGH_MESSAGE(mask, actual, message)                   \
  UNITY_TEST_ASSERT_BITS(                                                      \
    (mask), (UNITY_UINT32)(-1), (actual), __LINE__, (message))
#define TEST_ASSERT_BITS_LOW_MESSAGE(mask, actual, message)                    \
  UNITY_TEST_ASSERT_BITS(                                                      \
    (mask), (UNITY_UINT32)(0), (actual), __LINE__, (message))
#define TEST_ASSERT_BIT_HIGH_MESSAGE(bit, actual, message)                     \
  UNITY_TEST_ASSERT_BITS(((UNITY_UINT32)1 << (bit)),                           \
                         (UNITY_UINT32)(-1),                                   \
                         (actual),                                             \
                         __LINE__,                                             \
                         (message))
...
#define TEST_ASSERT_GREATER_THAN_INT8_MESSAGE(threshold, actual, message)      \
  UNITY_TEST_ASSERT_GREATER_THAN_INT8(                                         \
    (threshold), (actual), __LINE__, (message))
...
#define TEST_ASSERT_GREATER_OR_EQUAL_UINT8_MESSAGE(threshold, actual, message) \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_UINT8(                                    \
    (threshold), (actual), __LINE__, (message))
#define TEST_ASSERT_GREATER_OR_EQUAL_UINT16_MESSAGE(                           \
  threshold, actual, message)                                                  \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_UINT16(                                   \
    (threshold), (actual), __LINE__, (message))
#define TEST_ASSERT_GREATER_OR_EQUAL_UINT32_MESSAGE(                           \
  threshold, actual, message)                                                  \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_UINT32(                                   \
    (threshold), (actual), __LINE__, (message))
#define TEST_ASSERT_GREATER_OR_EQUAL_UINT64_MESSAGE(                           \
  threshold, actual, message)                                                  \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_UINT64(                                   \
    (threshold), (actual), __LINE__, (message))
#define TEST_ASSERT_GREATER_OR_EQUAL_size_t_MESSAGE(                           \
  threshold, actual, message)                                                  \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_UINT(                                     \
    (threshold), (actual), __LINE__, (message))
...
#define TEST_ASSERT_INT_WITHIN_MESSAGE(delta, expected, actual, message)       \
  UNITY_TEST_ASSERT_INT_WITHIN(                                                \
    (delta), (expected), (actual), __LINE__, (message))
...
/* Integer Array Ranges (of all sizes) */
#define TEST_ASSERT_INT_ARRAY_WITHIN_MESSAGE(                                  \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_INT_ARRAY_WITHIN(                                          \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_INT8_ARRAY_WITHIN_MESSAGE(                                 \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_INT8_ARRAY_WITHIN(                                         \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_INT16_ARRAY_WITHIN_MESSAGE(                                \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_INT16_ARRAY_WITHIN(                                        \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_INT32_ARRAY_WITHIN_MESSAGE(                                \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_INT32_ARRAY_WITHIN(                                        \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_INT64_ARRAY_WITHIN_MESSAGE(                                \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_INT64_ARRAY_WITHIN(                                        \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_UINT_ARRAY_WITHIN_MESSAGE(                                 \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_UINT_ARRAY_WITHIN(                                         \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_UINT8_ARRAY_WITHIN_MESSAGE(                                \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_UINT8_ARRAY_WITHIN(                                        \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_UINT16_ARRAY_WITHIN_MESSAGE(                               \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_UINT16_ARRAY_WITHIN(                                       \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_UINT32_ARRAY_WITHIN_MESSAGE(                               \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_UINT32_ARRAY_WITHIN(                                       \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_UINT64_ARRAY_WITHIN_MESSAGE(                               \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_UINT64_ARRAY_WITHIN(                                       \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_size_t_ARRAY_WITHIN_MESSAGE(                               \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_UINT_ARRAY_WITHIN(                                         \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_HEX_ARRAY_WITHIN_MESSAGE(                                  \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_HEX32_ARRAY_WITHIN(                                        \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_HEX8_ARRAY_WITHIN_MESSAGE(                                 \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_HEX8_ARRAY_WITHIN(                                         \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_HEX16_ARRAY_WITHIN_MESSAGE(                                \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_HEX16_ARRAY_WITHIN(                                        \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_HEX32_ARRAY_WITHIN_MESSAGE(                                \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_HEX32_ARRAY_WITHIN(                                        \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_HEX64_ARRAY_WITHIN_MESSAGE(                                \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_HEX64_ARRAY_WITHIN(                                        \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
#define TEST_ASSERT_CHAR_ARRAY_WITHIN_MESSAGE(                                 \
  delta, expected, actual, num_elements, message)                              \
  UNITY_TEST_ASSERT_CHAR_ARRAY_WITHIN(                                         \
    (delta), (expected), (actual), num_elements, __LINE__, (message))
...
#define TEST_ASSERT_EQUAL_STRING_LEN_MESSAGE(expected, actual, len, message)   \
  UNITY_TEST_ASSERT_EQUAL_STRING_LEN(                                          \
    (expected), (actual), (len), __LINE__, (message))
...
#define TEST_ASSERT_EQUAL_INT_ARRAY_MESSAGE(                                   \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_INT_ARRAY(                                           \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_INT8_ARRAY_MESSAGE(                                  \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_INT8_ARRAY(                                          \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_INT16_ARRAY_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_INT16_ARRAY(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_INT32_ARRAY_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_INT32_ARRAY(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_INT64_ARRAY_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_INT64_ARRAY(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_UINT_ARRAY_MESSAGE(                                  \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_UINT_ARRAY(                                          \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_UINT8_ARRAY_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_UINT8_ARRAY(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_UINT16_ARRAY_MESSAGE(                                \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_UINT16_ARRAY(                                        \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_UINT32_ARRAY_MESSAGE(                                \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_UINT32_ARRAY(                                        \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_UINT64_ARRAY_MESSAGE(                                \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_UINT64_ARRAY(                                        \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_size_t_ARRAY_MESSAGE(                                \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_UINT_ARRAY(                                          \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_HEX_ARRAY_MESSAGE(                                   \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_HEX32_ARRAY(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_HEX8_ARRAY_MESSAGE(                                  \
  ...
  UNITY_TEST_ASSERT_EQUAL_HEX8_ARRAY(                                          \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_HEX16_ARRAY_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_HEX16_ARRAY(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_HEX32_ARRAY_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_HEX32_ARRAY(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_HEX64_ARRAY_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_HEX64_ARRAY(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_PTR_ARRAY_MESSAGE(                                   \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_PTR_ARRAY(                                           \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_STRING_ARRAY_MESSAGE(                                \
  ...
  UNITY_TEST_ASSERT_EQUAL_STRING_ARRAY(                                        \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_MEMORY_ARRAY_MESSAGE(                                \
  expected, actual, len, num_elements, message)                                \
  UNITY_TEST_ASSERT_EQUAL_MEMORY_ARRAY(                                        \
    (expected), (actual), (len), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_CHAR_ARRAY_MESSAGE(                                  \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_CHAR_ARRAY(                                          \
    (expected), (actual), (num_elements), __LINE__, (message))

/* Arrays Compared To Single Value*/
#define TEST_ASSERT_EACH_EQUAL_INT_MESSAGE(                                    \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_INT(                                            \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_INT8_MESSAGE(                                   \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_INT8(                                           \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_INT16_MESSAGE(                                  \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_INT16(                                          \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_INT32_MESSAGE(                                  \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_INT32(                                          \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_INT64_MESSAGE(                                  \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_INT64(                                          \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_UINT_MESSAGE(                                   \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_UINT(                                           \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_UINT8_MESSAGE(                                  \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_UINT8(                                          \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_UINT16_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_UINT16(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_UINT32_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_UINT32(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_UINT64_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_UINT64(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_size_t_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_UINT(                                           \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_HEX_MESSAGE(                                    \
  ...
  UNITY_TEST_ASSERT_EACH_EQUAL_HEX32(                                          \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_HEX8_MESSAGE(                                   \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_HEX8(                                           \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_HEX16_MESSAGE(                                  \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_HEX16(                                          \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_HEX32_MESSAGE(                                  \
  ...
  UNITY_TEST_ASSERT_EACH_EQUAL_HEX32(                                          \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_HEX64_MESSAGE(                                  \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_HEX64(                                          \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_PTR_MESSAGE(                                    \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_PTR(                                            \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_STRING_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_STRING(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_MEMORY_MESSAGE(                                 \
  expected, actual, len, num_elements, message)                                \
  UNITY_TEST_ASSERT_EACH_EQUAL_MEMORY(                                         \
    (expected), (actual), (len), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_CHAR_MESSAGE(                                   \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_CHAR(                                           \
    (expected), (actual), (num_elements), __LINE__, (message))
...
#define TEST_ASSERT_EQUAL_FLOAT_ARRAY_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EQUAL_FLOAT_ARRAY(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
...
#define TEST_ASSERT_EQUAL_DOUBLE_ARRAY_MESSAGE(                                \
  ...
  UNITY_TEST_ASSERT_EQUAL_DOUBLE_ARRAY(                                        \
    (expected), (actual), (num_elements), __LINE__, (message))
#define TEST_ASSERT_EACH_EQUAL_DOUBLE_MESSAGE(                                 \
  expected, actual, num_elements, message)                                     \
  UNITY_TEST_ASSERT_EACH_EQUAL_DOUBLE(                                         \
    (expected), (actual), (num_elements), __LINE__, (message))
...
#define TEST_ASSERT_EQUAL_MESSAGE(expected, actual, message)                   \
  UNITY_TEST_ASSERT_EQUAL_MEMORY(                                              \
    (&expected), (&actual), sizeof(expected), __LINE__, message)
#define TEST_ASSERT_NOT_EQUAL_MESSAGE(expected, actual, message)               \
  UNITY_TEST_FAIL(__LINE__, UnityStrErrShorthand)
#endif
#ifdef UNITY_SHORTHAND_AS_RAW
