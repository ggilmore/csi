...
void
UnityBegin(const char* filename);
int
UnityEnd(void);
void
UnitySetTestFile(const char* filename);
void
UnityConcludeTest(void);

#ifndef RUN_TEST
void
UnityDefaultTestRun(UnityTestFunction Func,
                    const char* FuncName,
...
#ifdef UNITY_INCLUDE_PRINT_FORMATTED
void
UnityPrintF(const UNITY_LINE_TYPE line, const char* format, ...);
#endif

void
UnityPrintLen(const char* string, const UNITY_UINT32 length);
void
UnityPrintMask(const UNITY_UINT mask, const UNITY_UINT number);
void
UnityPrintNumberByStyle(const UNITY_INT number,
                        const UNITY_DISPLAY_STYLE_T style);
void
UnityPrintNumber(const UNITY_INT number_to_print);
void
UnityPrintNumberUnsigned(const UNITY_UINT number);
void
UnityPrintNumberHex(const UNITY_UINT number, const char nibbles_to_print);

#ifndef UNITY_EXCLUDE_FLOAT_PRINT
void
UnityPrintFloat(const UNITY_DOUBLE input_number);
#endif
...
void
UnityAssertEqualNumber(const UNITY_INT expected,
...
void
UnityAssertGreaterOrLessOrEqualNumber(const UNITY_INT threshold,
                                      const UNITY_INT actual,
...
void
UnityAssertBits(const UNITY_INT mask,
...
void
UnityAssertNumbersWithin(const UNITY_UINT delta,
                         const UNITY_INT expected,
                         const UNITY_INT actual,
                         const char* msg,
                         const UNITY_LINE_TYPE lineNumber,
...
void
UnityAssertNumbersArrayWithin(const UNITY_UINT delta,
...
UnityIgnore(const char* message, const UNITY_LINE_TYPE line)
  UNITY_FUNCTION_ATTR(noreturn);
void
UnityMessage(const char* message, const UNITY_LINE_TYPE line);

#ifndef UNITY_EXCLUDE_FLOAT
void
UnityAssertFloatsWithin(const UNITY_FLOAT delta,
...
void
UnityAssertEqualFloatArray(UNITY_PTR_ATTRIBUTE const UNITY_FLOAT* expected,
...
void
UnityAssertFloatSpecial(const UNITY_FLOAT actual,
                        const char* msg,
                        const UNITY_LINE_TYPE lineNumber,
...
#ifndef UNITY_EXCLUDE_DOUBLE
void
UnityAssertDoublesWithin(const UNITY_DOUBLE delta,
...
void
UnityAssertEqualDoubleArray(UNITY_PTR_ATTRIBUTE const UNITY_DOUBLE* expected,
...
void
UnityAssertDoubleSpecial(const UNITY_DOUBLE actual,
                         const char* msg,
                         const UNITY_LINE_TYPE lineNumber,
                         const UNITY_FLOAT_TRAIT_T style);
#endif
...
UNITY_INTERNAL_PTR
UnityNumToPtr(const UNITY_INT num, const UNITY_UINT8 size);
#ifndef UNITY_EXCLUDE_FLOAT
UNITY_INTERNAL_PTR
UnityFloatToPtr(const float num);
#endif
#ifndef UNITY_EXCLUDE_DOUBLE
UNITY_INTERNAL_PTR
UnityDoubleToPtr(const double num);
#endif
...
int
UnityParseOptions(int argc, char** argv);
int
UnityTestMatches(void);
#endif
...
#define UNITY_TEST_ASSERT_EQUAL_INT8(expected, actual, line, message)          \
  UnityAssertEqualNumber((UNITY_INT)(UNITY_INT8)(expected),                    \
...
#define UNITY_TEST_ASSERT_EQUAL_UINT8(expected, actual, line, message)         \
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8)(expected),                   \
                         (UNITY_INT)(UNITY_UINT8)(actual),                     \
                         (message),                                            \
                         (UNITY_LINE_TYPE)(line),                              \
                         UNITY_DISPLAY_STYLE_UINT8)
#define UNITY_TEST_ASSERT_EQUAL_UINT16(expected, actual, line, message)        \
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT16)(expected),                  \
...
#define UNITY_TEST_ASSERT_EQUAL_UINT32(expected, actual, line, message)        \
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)(expected),                  \
...
#define UNITY_TEST_ASSERT_BITS(mask, expected, actual, line, message)          \
  UnityAssertBits((UNITY_INT)(mask),                                           \
                  (UNITY_INT)(expected),                                       \
                  (UNITY_INT)(actual),                                         \
                  (message),                                                   \
                  (UNITY_LINE_TYPE)(line))
...
#define UNITY_TEST_ASSERT_GREATER_THAN_UINT8(threshold, actual, line, message) \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT8)(threshold),   \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_UINT8)
#define UNITY_TEST_ASSERT_GREATER_THAN_UINT16(                                 \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT16)(threshold),  \
                                        (UNITY_INT)(UNITY_UINT16)(actual),     \
                                        UNITY_GREATER_THAN,                    \
                                        (message),                             \
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_UINT16)
#define UNITY_TEST_ASSERT_GREATER_THAN_UINT32(                                 \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT32)(threshold),  \
                                        (UNITY_INT)(UNITY_UINT32)(actual),     \
                                        UNITY_GREATER_THAN,                    \
...
#define UNITY_TEST_ASSERT_SMALLER_THAN_UINT8(threshold, actual, line, message) \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT8)(threshold),   \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_UINT8)
#define UNITY_TEST_ASSERT_SMALLER_THAN_UINT16(                                 \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT16)(threshold),  \
                                        (UNITY_INT)(UNITY_UINT16)(actual),     \
                                        UNITY_SMALLER_THAN,                    \
...
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_INT(                                \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        (UNITY_INT)(actual),                   \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_INT)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_INT8(                               \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_INT8)(threshold),    \
                                        (UNITY_INT)(UNITY_INT8)(actual),       \
                                        UNITY_GREATER_OR_EQUAL,                \
...
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_INT16(                              \
  ...
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_INT16)(threshold),   \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_INT16)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_INT32(                              \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_INT32)(threshold),   \
                                        (UNITY_INT)(UNITY_INT32)(actual),      \
                                        UNITY_GREATER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_INT32)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_UINT(                               \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        (UNITY_INT)(actual),                   \
                                        UNITY_GREATER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_UINT)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_UINT8(                              \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT8)(threshold),   \
                                        (UNITY_INT)(UNITY_UINT8)(actual),      \
                                        UNITY_GREATER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_UINT8)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_UINT16(                             \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT16)(threshold),  \
                                        (UNITY_INT)(UNITY_UINT16)(actual),     \
                                        UNITY_GREATER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_UINT16)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_UINT32(                             \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT32)(threshold),  \
                                        (UNITY_INT)(UNITY_UINT32)(actual),     \
                                        UNITY_GREATER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_UINT32)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_HEX8(                               \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT8)(threshold),   \
                                        (UNITY_INT)(UNITY_UINT8)(actual),      \
                                        UNITY_GREATER_OR_EQUAL,                \
...
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_HEX16(                              \
  ...
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT16)(threshold),  \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_HEX16)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_HEX32(                              \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT32)(threshold),  \
                                        (UNITY_INT)(UNITY_UINT32)(actual),     \
                                        UNITY_GREATER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_HEX32)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_CHAR(                               \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_INT8)(threshold),    \
                                        (UNITY_INT)(UNITY_INT8)(actual),       \
                                        UNITY_GREATER_OR_EQUAL,                \
...
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_INT(                                \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        (UNITY_INT)(actual),                   \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_INT)
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_INT8(                               \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_INT8)(threshold),    \
                                        (UNITY_INT)(UNITY_INT8)(actual),       \
                                        UNITY_SMALLER_OR_EQUAL,                \
...
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_INT16(                              \
  ...
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_INT16)(threshold),   \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_INT16)
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_INT32(                              \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_INT32)(threshold),   \
                                        (UNITY_INT)(UNITY_INT32)(actual),      \
                                        UNITY_SMALLER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_INT32)
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_UINT(                               \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        (UNITY_INT)(actual),                   \
                                        UNITY_SMALLER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_UINT)
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_UINT8(                              \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT8)(threshold),   \
                                        (UNITY_INT)(UNITY_UINT8)(actual),      \
                                        UNITY_SMALLER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_UINT8)
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_UINT16(                             \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT16)(threshold),  \
                                        (UNITY_INT)(UNITY_UINT16)(actual),     \
                                        UNITY_SMALLER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_UINT16)
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_UINT32(                             \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT32)(threshold),  \
                                        (UNITY_INT)(UNITY_UINT32)(actual),     \
                                        UNITY_SMALLER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_UINT32)
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_HEX8(                               \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT8)(threshold),   \
                                        (UNITY_INT)(UNITY_UINT8)(actual),      \
                                        UNITY_SMALLER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_HEX8)
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_HEX16(                              \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT16)(threshold),  \
                                        (UNITY_INT)(UNITY_UINT16)(actual),     \
                                        UNITY_SMALLER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_HEX16)
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_HEX32(                              \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_UINT32)(threshold),  \
                                        (UNITY_INT)(UNITY_UINT32)(actual),     \
                                        UNITY_SMALLER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_HEX32)
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_CHAR(                               \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(UNITY_INT8)(threshold),    \
                                        (UNITY_INT)(UNITY_INT8)(actual),       \
                                        UNITY_SMALLER_OR_EQUAL,                \
...
#define UNITY_TEST_ASSERT_INT8_WITHIN(delta, expected, actual, line, message)  \
  UnityAssertNumbersWithin((UNITY_UINT8)(delta),                               \
...
#define UNITY_TEST_ASSERT_UINT8_WITHIN(delta, expected, actual, line, message) \
  UnityAssertNumbersWithin((UNITY_UINT8)(delta),                               \
                           ...
                           (UNITY_INT)(UNITY_UINT)(UNITY_UINT8)(actual),       \
                           (message),                                          \
                           (UNITY_LINE_TYPE)(line),                            \
                           UNITY_DISPLAY_STYLE_UINT8)
#define UNITY_TEST_ASSERT_UINT16_WITHIN(                                       \
  delta, expected, actual, line, message)                                      \
  UnityAssertNumbersWithin((UNITY_UINT16)(delta),                              \
                           (UNITY_INT)(UNITY_UINT)(UNITY_UINT16)(expected),    \
                           (UNITY_INT)(UNITY_UINT)(UNITY_UINT16)(actual),      \
                           (message),                                          \
                           (UNITY_LINE_TYPE)(line),                            \
                           UNITY_DISPLAY_STYLE_UINT16)
#define UNITY_TEST_ASSERT_UINT32_WITHIN(                                       \
  delta, expected, actual, line, message)                                      \
  UnityAssertNumbersWithin((UNITY_UINT32)(delta),                              \
                           (UNITY_INT)(UNITY_UINT)(UNITY_UINT32)(expected),    \
                           (UNITY_INT)(UNITY_UINT)(UNITY_UINT32)(actual),      \
                           (message),                                          \
                           (UNITY_LINE_TYPE)(line),                            \
                           UNITY_DISPLAY_STYLE_UINT32)
...
#define UNITY_TEST_ASSERT_INT_ARRAY_WITHIN(                                    \
  delta, expected, actual, num_elements, line, message)                        \
  UnityAssertNumbersArrayWithin((delta),                                       \
                                (UNITY_INTERNAL_PTR)(expected),                \
                                (UNITY_INTERNAL_PTR)(actual),                  \
                                ...
                                UNITY_DISPLAY_STYLE_INT,                       \
                                UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_INT8_ARRAY_WITHIN(                                   \
  delta, expected, actual, num_elements, line, message)                        \
  UnityAssertNumbersArrayWithin((UNITY_UINT8)(delta),                          \
                                (UNITY_INTERNAL_PTR)(expected),                \
                                (UNITY_INTERNAL_PTR)(actual),                  \
                                ((UNITY_UINT32)(num_elements)),                \
                                (message),                                     \
...
#define UNITY_TEST_ASSERT_INT16_ARRAY_WITHIN(                                  \
  delta, expected, actual, num_elements, line, message)                        \
  UnityAssertNumbersArrayWithin((UNITY_UINT16)(delta),                         \
                                (UNITY_INTERNAL_PTR)(expected),                \
                                (UNITY_INTERNAL_PTR)(actual),                  \
                                ((UNITY_UINT32)(num_elements)),                \
                                (message),                                     \
...
#define UNITY_TEST_ASSERT_INT32_ARRAY_WITHIN(                                  \
  delta, expected, actual, num_elements, line, message)                        \
  UnityAssertNumbersArrayWithin((UNITY_UINT32)(delta),                         \
                                (UNITY_INTERNAL_PTR)(expected),                \
                                (UNITY_INTERNAL_PTR)(actual),                  \
                                ((UNITY_UINT32)(num_elements)),                \
                                (message),                                     \
                                ...
                                UNITY_DISPLAY_STYLE_INT32,                     \
                                UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_UINT_ARRAY_WITHIN(                                   \
  delta, expected, actual, num_elements, line, message)                        \
  UnityAssertNumbersArrayWithin((delta),                                       \
                                (UNITY_INTERNAL_PTR)(expected),                \
                                (UNITY_INTERNAL_PTR)(actual),                  \
...
#define UNITY_TEST_ASSERT_UINT8_ARRAY_WITHIN(                                  \
  ...
  UnityAssertNumbersArrayWithin((UNITY_UINT16)(delta),                         \
                                ...
                                UNITY_DISPLAY_STYLE_UINT8,                     \
                                UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_UINT16_ARRAY_WITHIN(                                 \
  delta, expected, actual, num_elements, line, message)                        \
  UnityAssertNumbersArrayWithin((UNITY_UINT16)(delta),                         \
                                (UNITY_INTERNAL_PTR)(expected),                \
                                (UNITY_INTERNAL_PTR)(actual),                  \
...
#define UNITY_TEST_ASSERT_UINT32_ARRAY_WITHIN(                                 \
  ...
  UnityAssertNumbersArrayWithin((UNITY_UINT32)(delta),                         \
                                ...
                                UNITY_DISPLAY_STYLE_UINT32,                    \
                                UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_HEX8_ARRAY_WITHIN(                                   \
  delta, expected, actual, num_elements, line, message)                        \
  UnityAssertNumbersArrayWithin((UNITY_UINT8)(delta),                          \
                                (UNITY_INTERNAL_PTR)(expected),                \
                                (UNITY_INTERNAL_PTR)(actual),                  \
                                ...
                                UNITY_DISPLAY_STYLE_HEX8,                      \
                                UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_HEX16_ARRAY_WITHIN(                                  \
  delta, expected, actual, num_elements, line, message)                        \
  UnityAssertNumbersArrayWithin((UNITY_UINT16)(delta),                         \
                                (UNITY_INTERNAL_PTR)(expected),                \
                                (UNITY_INTERNAL_PTR)(actual),                  \
                                ...
                                UNITY_DISPLAY_STYLE_HEX16,                     \
                                UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_HEX32_ARRAY_WITHIN(                                  \
  delta, expected, actual, num_elements, line, message)                        \
  UnityAssertNumbersArrayWithin((UNITY_UINT32)(delta),                         \
                                (UNITY_INTERNAL_PTR)(expected),                \
                                (UNITY_INTERNAL_PTR)(actual),                  \
                                ...
                                UNITY_DISPLAY_STYLE_HEX32,                     \
                                UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_CHAR_ARRAY_WITHIN(                                   \
  delta, expected, actual, num_elements, line, message)                        \
  UnityAssertNumbersArrayWithin((UNITY_UINT8)(delta),                          \
                                (UNITY_INTERNAL_PTR)(expected),                \
                                (UNITY_INTERNAL_PTR)(actual),                  \
...
#define UNITY_TEST_ASSERT_EQUAL_PTR(expected, actual, line, message)           \
  UnityAssertEqualNumber((UNITY_PTR_TO_INT)(expected),                         \
                         (UNITY_PTR_TO_INT)(actual),                           \
                         (message),                                            \
                         (UNITY_LINE_TYPE)(line),                              \
...
#define UNITY_TEST_ASSERT_EQUAL_STRING(expected, actual, line, message)        \
  UnityAssertEqualString((const char*)(expected),                              \
                         ...
                         (message),                                            \
                         (UNITY_LINE_TYPE)(line))
#define UNITY_TEST_ASSERT_EQUAL_STRING_LEN(                                    \
  expected, actual, len, line, message)                                        \
  UnityAssertEqualStringLen((const char*)(expected),                           \
                            (const char*)(actual),                             \
                            (UNITY_UINT32)(len),                               \
                            (message),                                         \
...
#define UNITY_TEST_ASSERT_EQUAL_INT_ARRAY(                                     \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           (UNITY_INTERNAL_PTR)(actual),                       \
                           (UNITY_UINT32)(num_elements),                       \
                           (message),                                          \
                           ...
                           UNITY_DISPLAY_STYLE_INT,                            \
                           UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_EQUAL_INT8_ARRAY(                                    \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           (UNITY_INTERNAL_PTR)(actual),                       \
                           (UNITY_UINT32)(num_elements),                       \
                           ...
                           UNITY_DISPLAY_STYLE_INT8,                           \
                           UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_EQUAL_INT16_ARRAY(                                   \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           (UNITY_INTERNAL_PTR)(actual),                       \
                           (UNITY_UINT32)(num_elements),                       \
                           ...
                           UNITY_DISPLAY_STYLE_INT16,                          \
                           UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_EQUAL_INT32_ARRAY(                                   \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           (UNITY_INTERNAL_PTR)(actual),                       \
                           (UNITY_UINT32)(num_elements),                       \
                           ...
                           UNITY_DISPLAY_STYLE_INT32,                          \
                           UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_EQUAL_UINT_ARRAY(                                    \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           (UNITY_INTERNAL_PTR)(actual),                       \
                           (UNITY_UINT32)(num_elements),                       \
                           ...
                           UNITY_DISPLAY_STYLE_UINT,                           \
                           UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_EQUAL_UINT8_ARRAY(                                   \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           (UNITY_INTERNAL_PTR)(actual),                       \
                           (UNITY_UINT32)(num_elements),                       \
                           ...
                           UNITY_DISPLAY_STYLE_UINT8,                          \
                           UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_EQUAL_UINT16_ARRAY(                                  \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           (UNITY_INTERNAL_PTR)(actual),                       \
                           (UNITY_UINT32)(num_elements),                       \
...
#define UNITY_TEST_ASSERT_EQUAL_HEX16_ARRAY(                                   \
  ...
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           ...
                           UNITY_DISPLAY_STYLE_HEX16,                          \
                           UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_EQUAL_HEX32_ARRAY(                                   \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           (UNITY_INTERNAL_PTR)(actual),                       \
                           (UNITY_UINT32)(num_elements),                       \
...
#define UNITY_TEST_ASSERT_EQUAL_PTR_ARRAY(                                     \
  ...
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           ...
                           UNITY_DISPLAY_STYLE_POINTER,                        \
                           UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_EQUAL_STRING_ARRAY(                                  \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualStringArray((UNITY_INTERNAL_PTR)(expected),                  \
                              (const char**)(actual),                          \
                              (UNITY_UINT32)(num_elements),                    \
                              ...
                              (UNITY_LINE_TYPE)(line),                         \
                              UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_EQUAL_MEMORY_ARRAY(                                  \
  expected, actual, len, num_elements, line, message)                          \
  UnityAssertEqualMemory((UNITY_INTERNAL_PTR)(expected),                       \
                         (UNITY_INTERNAL_PTR)(actual),                         \
                         (UNITY_UINT32)(len),                                  \
                         (UNITY_UINT32)(num_elements),                         \
                         ...
                         (UNITY_LINE_TYPE)(line),                              \
                         UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_EQUAL_CHAR_ARRAY(                                    \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           (UNITY_INTERNAL_PTR)(actual),                       \
                           (UNITY_UINT32)(num_elements),                       \
...
#define UNITY_TEST_ASSERT_EACH_EQUAL_INT(                                      \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
    ...
    UNITY_DISPLAY_STYLE_INT,                                                   \
    UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_EACH_EQUAL_INT8(                                     \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
    ...
    UNITY_DISPLAY_STYLE_INT8,                                                  \
    UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_EACH_EQUAL_INT16(                                    \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
    ...
    UNITY_DISPLAY_STYLE_INT16,                                                 \
    UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_EACH_EQUAL_INT32(                                    \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
...
#define UNITY_TEST_ASSERT_EACH_EQUAL_UINT(                                     \
  ...
  UnityAssertEqualIntArray(                                                    \
    ...
    UNITY_DISPLAY_STYLE_UINT,                                                  \
    UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_EACH_EQUAL_UINT8(                                    \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
    ...
    UNITY_DISPLAY_STYLE_UINT8,                                                 \
    UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_EACH_EQUAL_UINT16(                                   \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
    ...
    UNITY_DISPLAY_STYLE_UINT16,                                                \
    UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_EACH_EQUAL_UINT32(                                   \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
    ...
    UNITY_DISPLAY_STYLE_UINT32,                                                \
    UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_EACH_EQUAL_HEX8(                                     \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
    UnityNumToPtr((UNITY_INT)(UNITY_INT8)(expected), 1),                       \
    (UNITY_INTERNAL_PTR)(actual),                                              \
    ...
    UNITY_DISPLAY_STYLE_HEX8,                                                  \
    UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_EACH_EQUAL_HEX16(                                    \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
    UnityNumToPtr((UNITY_INT)(UNITY_INT16)(expected), 2),                      \
    (UNITY_INTERNAL_PTR)(actual),                                              \
    ...
    UNITY_DISPLAY_STYLE_HEX16,                                                 \
    UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_EACH_EQUAL_HEX32(                                    \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
    UnityNumToPtr((UNITY_INT)(UNITY_INT32)(expected), 4),                      \
    (UNITY_INTERNAL_PTR)(actual),                                              \
...
#define UNITY_TEST_ASSERT_EACH_EQUAL_PTR(                                      \
  ...
  UnityAssertEqualIntArray(                                                    \
    ...
    UNITY_DISPLAY_STYLE_POINTER,                                               \
    UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_EACH_EQUAL_STRING(                                   \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualStringArray((UNITY_INTERNAL_PTR)(expected),                  \
                              (const char**)(actual),                          \
                              (UNITY_UINT32)(num_elements),                    \
                              ...
                              (UNITY_LINE_TYPE)(line),                         \
                              UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_EACH_EQUAL_MEMORY(                                   \
  expected, actual, len, num_elements, line, message)                          \
  UnityAssertEqualMemory((UNITY_INTERNAL_PTR)(expected),                       \
                         (UNITY_INTERNAL_PTR)(actual),                         \
                         (UNITY_UINT32)(len),                                  \
                         ...
                         (UNITY_LINE_TYPE)(line),                              \
                         UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_EACH_EQUAL_CHAR(                                     \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
    UnityNumToPtr((UNITY_INT)(UNITY_INT8)(expected), 1),                       \
    (UNITY_INTERNAL_PTR)(actual),                                              \
...
#define UNITY_TEST_ASSERT_EQUAL_INT64_ARRAY(                                   \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           (UNITY_INTERNAL_PTR)(actual),                       \
                           (UNITY_UINT32)(num_elements),                       \
                           ...
                           UNITY_DISPLAY_STYLE_INT64,                          \
                           UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_EQUAL_UINT64_ARRAY(                                  \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           (UNITY_INTERNAL_PTR)(actual),                       \
                           (UNITY_UINT32)(num_elements),                       \
                           ...
                           UNITY_DISPLAY_STYLE_UINT64,                         \
                           UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_EQUAL_HEX64_ARRAY(                                   \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected),                     \
                           (UNITY_INTERNAL_PTR)(actual),                       \
                           (UNITY_UINT32)(num_elements),                       \
                           ...
                           UNITY_DISPLAY_STYLE_HEX64,                          \
                           UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_EACH_EQUAL_INT64(                                    \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
...
#define UNITY_TEST_ASSERT_EACH_EQUAL_UINT64(                                   \
  ...
  UnityAssertEqualIntArray(                                                    \
    ...
    UNITY_DISPLAY_STYLE_UINT64,                                                \
    UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_EACH_EQUAL_HEX64(                                    \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualIntArray(                                                    \
    UnityNumToPtr((UNITY_INT)(UNITY_INT64)(expected), 8),                      \
    (UNITY_INTERNAL_PTR)(actual),                                              \
...
#define UNITY_TEST_ASSERT_INT64_WITHIN(delta, expected, actual, line, message) \
  UnityAssertNumbersWithin((delta),                                            \
                           ...
                           (UNITY_LINE_TYPE)(line),                            \
                           UNITY_DISPLAY_STYLE_INT64)
#define UNITY_TEST_ASSERT_UINT64_WITHIN(                                       \
  delta, expected, actual, line, message)                                      \
  UnityAssertNumbersWithin((delta),                                            \
                           (UNITY_INT)(expected),                              \
                           (UNITY_INT)(actual),                                \
...
#define UNITY_TEST_ASSERT_GREATER_THAN_INT64(threshold, actual, line, message) \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_INT64)
#define UNITY_TEST_ASSERT_GREATER_THAN_UINT64(                                 \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        (UNITY_INT)(actual),                   \
                                        UNITY_GREATER_THAN,                    \
...
#define UNITY_TEST_ASSERT_GREATER_THAN_HEX64(threshold, actual, line, message) \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_HEX64)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_INT64(                              \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        (UNITY_INT)(actual),                   \
                                        UNITY_GREATER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_INT64)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_UINT64(                             \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        (UNITY_INT)(actual),                   \
                                        UNITY_GREATER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_UINT64)
#define UNITY_TEST_ASSERT_GREATER_OR_EQUAL_HEX64(                              \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        (UNITY_INT)(actual),                   \
                                        UNITY_GREATER_OR_EQUAL,                \
...
#define UNITY_TEST_ASSERT_SMALLER_THAN_HEX64(threshold, actual, line, message) \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_HEX64)
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_INT64(                              \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        (UNITY_INT)(actual),                   \
                                        UNITY_SMALLER_OR_EQUAL,                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_INT64)
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_UINT64(                             \
  threshold, actual, line, message)                                            \
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        (UNITY_INT)(actual),                   \
                                        UNITY_SMALLER_OR_EQUAL,                \
...
#define UNITY_TEST_ASSERT_SMALLER_OR_EQUAL_HEX64(                              \
  ...
  UnityAssertGreaterOrLessOrEqualNumber((UNITY_INT)(threshold),                \
                                        ...
                                        (UNITY_LINE_TYPE)(line),               \
                                        UNITY_DISPLAY_STYLE_HEX64)
#define UNITY_TEST_ASSERT_INT64_ARRAY_WITHIN(                                  \
  delta, expected, actual, num_elements, line, message)                        \
  UnityAssertNumbersArrayWithin((UNITY_UINT64)(delta),                         \
                                (UNITY_INTERNAL_PTR)(expected),                \
                                (UNITY_INTERNAL_PTR)(actual),                  \
                                (UNITY_UINT32)(num_elements),                  \
                                (message),                                     \
...
#define UNITY_TEST_ASSERT_UINT64_ARRAY_WITHIN(                                 \
  ...
  UnityAssertNumbersArrayWithin((UNITY_UINT64)(delta),                         \
                                ...
                                UNITY_DISPLAY_STYLE_UINT64,                    \
                                UNITY_ARRAY_TO_ARRAY)
#define UNITY_TEST_ASSERT_HEX64_ARRAY_WITHIN(                                  \
  delta, expected, actual, num_elements, line, message)                        \
  UnityAssertNumbersArrayWithin((UNITY_UINT64)(delta),                         \
                                (UNITY_INTERNAL_PTR)(expected),                \
                                (UNITY_INTERNAL_PTR)(actual),                  \
...
#define UNITY_TEST_ASSERT_EQUAL_FLOAT_ARRAY(                                   \
  expected, actual, num_elements, line, message)                               \
  UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrFloat)
#define UNITY_TEST_ASSERT_EACH_EQUAL_FLOAT(                                    \
  expected, actual, num_elements, line, message)                               \
  UNITY_TEST_FAIL((UNITY_LINE_TYPE)(line), UnityStrErrFloat)
...
#else
#define UNITY_TEST_ASSERT_FLOAT_WITHIN(delta, expected, actual, line, message) \
  UnityAssertFloatsWithin((UNITY_FLOAT)(delta),                                \
                          (UNITY_FLOAT)(expected),                             \
                          (UNITY_FLOAT)(actual),                               \
                          (message),                                           \
                          (UNITY_LINE_TYPE)(line))
#define UNITY_TEST_ASSERT_EQUAL_FLOAT(expected, actual, line, message)         \
  UNITY_TEST_ASSERT_FLOAT_WITHIN((UNITY_FLOAT)(expected) *                     \
                                   (UNITY_FLOAT)UNITY_FLOAT_PRECISION,         \
                                 (UNITY_FLOAT)(expected),                      \
                                 (UNITY_FLOAT)(actual),                        \
                                 (UNITY_LINE_TYPE)(line),                      \
                                 (message))
#define UNITY_TEST_ASSERT_EQUAL_FLOAT_ARRAY(                                   \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualFloatArray((UNITY_FLOAT*)(expected),                         \
                             (UNITY_FLOAT*)(actual),                           \
                             (UNITY_UINT32)(num_elements),                     \
                             (message),                                        \
                             (UNITY_LINE_TYPE)(line),                          \
...
#define UNITY_TEST_ASSERT_EACH_EQUAL_FLOAT(                                    \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualFloatArray(UnityFloatToPtr(expected),                        \
                             (UNITY_FLOAT*)(actual),                           \
                             (UNITY_UINT32)(num_elements),                     \
                             (message),                                        \
                             (UNITY_LINE_TYPE)(line),                          \
...
#define UNITY_TEST_ASSERT_DOUBLE_WITHIN(                                       \
  delta, expected, actual, line, message)                                      \
  UnityAssertDoublesWithin((UNITY_DOUBLE)(delta),                              \
                           (UNITY_DOUBLE)(expected),                           \
                           (UNITY_DOUBLE)(actual),                             \
                           (message),                                          \
                           (UNITY_LINE_TYPE)(line))
#define UNITY_TEST_ASSERT_EQUAL_DOUBLE(expected, actual, line, message)        \
  UNITY_TEST_ASSERT_DOUBLE_WITHIN((UNITY_DOUBLE)(expected) *                   \
                                    (UNITY_DOUBLE)UNITY_DOUBLE_PRECISION,      \
                                  (UNITY_DOUBLE)(expected),                    \
                                  (UNITY_DOUBLE)(actual),                      \
                                  (UNITY_LINE_TYPE)(line),                     \
                                  (message))
#define UNITY_TEST_ASSERT_EQUAL_DOUBLE_ARRAY(                                  \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualDoubleArray((UNITY_DOUBLE*)(expected),                       \
                              (UNITY_DOUBLE*)(actual),                         \
                              (UNITY_UINT32)(num_elements),                    \
                              (message),                                       \
                              (UNITY_LINE_TYPE)(line),                         \
...
#define UNITY_TEST_ASSERT_EACH_EQUAL_DOUBLE(                                   \
  expected, actual, num_elements, line, message)                               \
  UnityAssertEqualDoubleArray(UnityDoubleToPtr(expected),                      \
                              (UNITY_DOUBLE*)(actual),                         \
                              (UNITY_UINT32)(num_elements),                    \
                              (message),                                       \
                              (UNITY_LINE_TYPE)(line),                         \
                              UNITY_ARRAY_TO_VAL)
#define UNITY_TEST_ASSERT_DOUBLE_IS_INF(actual, line, message)                 \
  UnityAssertDoubleSpecial((UNITY_DOUBLE)(actual),                             \
                           (message),                                          \
                           (UNITY_LINE_TYPE)(line),                            \
                           UNITY_FLOAT_IS_INF)
#define UNITY_TEST_ASSERT_DOUBLE_IS_NEG_INF(actual, line, message)             \
